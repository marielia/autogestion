...
<f:view>
	...
	<h:column>
   		...
   		<t:panelGrid border="0" cellpadding="0" cellspacing="0" 
			...
			<t:column>
				<t:outputText value="Archivos Venta y Alicuota"/>
			</t:column>
			<t:column><h:outputText  value="&nbsp;&nbsp;" escape="false" /></t:column>
		</t:panelGrid>
		...
		<%/*FILTROS*/%>
			...
			<h:panelGrid columns="2" width="80%" columnClasses="cpo8,cpo8,cpo8" styleClass="columnaTablaCentrada" cellspacing="0" cellpadding="4">						 
				<h:column>
				   		<t:commandButton value="Generar Venta" actionListener="#{refReporteLibroDiarioBean.buscarVenta}" styleClass="boton">
				    	</t:commandButton>				    	
			 	</h:column>	
			 		
				<h:column>
					 		<t:commandButton value="Generar Alicuota" actionListener="#{refReporteLibroDiarioBean.buscarAlicuota}" styleClass="boton">
				    		</t:commandButton>				    	
			 	</h:column>				 	
			</h:panelGrid>
