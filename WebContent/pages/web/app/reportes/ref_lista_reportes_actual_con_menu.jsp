...
if(lyr=="Layer1")	
	document.all.Layer1.style.height='180px'; 

if(lyr=="Layer2")	
	document.all.Layer2.style.height='340px'; 	
	
if(lyr=="Layer3")	
	document.all.Layer3.style.height='150px'; 
	
		
if(lyr=="Layer4")	
	document.all.Layer4.style.height='50px'; 	


if(lyr=="Layer5")	
	document.all.Layer5.style.height='170px'; 	
}
...
document.all.Layer5.style.height='20px'; 
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" rightmargin="0" onload="start()">
		<%@ include file="../header.jsp" %>				
				<%@ include file="../menu_estatico.jsp" %>	
					...
					*/%>
					...
					<h:panelGrid   rendered="#{sessionScope.usuario.tipo==0}" columns="2" width="100%" columnClasses="cpo8SinFondo" styleClass="columnaTablaCentradaYArriba" cellspacing="0" cellpadding="4">						 
						...
						*/ %>
								...
								<h:panelGrid columns="1" width="100%" styleClass="columnaTablaCentrada" cellspacing="0" cellpadding="0">						 
									<h:column>					
										<t:graphicImage  styleClass="columnaTablaCentrada" value="/img/fondo_sistema2.jpg"/>
									</h:column>
								</h:panelGrid>
