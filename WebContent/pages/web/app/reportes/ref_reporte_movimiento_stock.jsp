			...
			<h:panelGrid columns="4" width="80%" columnClasses="cpo8,cpo8,cpo8,cpo8" styleClass="columnaTablaCentrada" cellspacing="0" cellpadding="4">						 
				...
				<h:column>
					<h:panelGrid columns="1" width="100%"  columnClasses="fondo" styleClass="columnaTablaNumero" cellspacing="0">						 
				     	<h:column>				     	
				    		<t:commandButton value="#{Message.buscar_label}" actionListener="#{refReporteMovimientoStock.buscar}" styleClass="boton"/>
				    	</h:column>
				 	</h:panelGrid> 
			 	</h:column>				 	
			</h:panelGrid>
					...
					<h:column>
						<f:facet name="header">
						 ...
						 <f:convertNumber type="currency" pattern="#,##0.00"/>
						  ...
						  <h:outputText value="#{item.saldoLitros}" rendered="#{item.ultimo!=1}">
						 <f:convertNumber type="currency" pattern="#,##0.00"/>
						 </h:outputText>
