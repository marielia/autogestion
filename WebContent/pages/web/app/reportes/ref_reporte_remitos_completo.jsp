...
<f:view>
	...
	<h:column>
		...
		<t:panelGrid border="0" cellpadding="0" cellspacing="0" 
			...
			<t:column>
				<t:outputText value="#{Message.tit_informe_remitos_completo}"/>
			</t:column>
			<t:column><h:outputText  value="&nbsp;&nbsp;" escape="false" /></t:column>
		</t:panelGrid>	
		...
		*/%>		
			...
			<h:panelGrid columns="1" width="100%" columnClasses="cpo8" styleClass="columnaTablaCentrada" cellspacing="0" cellpadding="4">						 
				<t:column rendered="#{sessionScope.tipoUsuarioLogueado==0" >
			...
			<h:panelGrid columns="4" width="100%" columnClasses="cpo8,cpo8,cpo8,cpo8" styleClass="columnaTablaCentrada" cellspacing="0" cellpadding="4">						 
				...
				<h:column>
					<h:panelGrid columns="1" width="100%"  columnClasses="fondo" styleClass="columnaTablaNumero" cellspacing="0">						 
				     	<h:column>				     	
				    		<t:commandButton value="#{Message.buscar_label}" id="buscarboton" actionListener="#{refReporteRemitosCompletoBean.buscar}" styleClass="boton"/>
				    	</h:column>
				 	</h:panelGrid> 
			 	</h:column>				 	
			</h:panelGrid>
