	...
	<h:column>
		...
		<h:column>		
				<t:dataTable value="#{refReporteCuposBean.subItemsNivel1}" var="item" 
							 ...
							 columnClasses="columnaTablaTexto,columnaTablaTexto,columnaTablaTexto,columnaTablaTexto,  columnaTablaTexto, columnaTablaTexto,  columnaTablaTexto,columnaTablaTexto,columnaTablaTexto,columnaTablaNumero,columnaTablaNumero,columnaTablaNumero,columnaTablaCentrada"
				   ...
				   <h:column>
					...
					<h:column>
						...
						<t:commandLink styleClass="linkOperacion" 
									   ...
									   <f:param name="familiaGrupoArticulo" id="familiaGrupoArticulo" value="#{item.familiaGrupoArticulo}"/>
