	...
	<h:column>
		...
		<h:column>		
				<t:dataTable value="#{refReporteReciboBean.subItemsNivel1}" var="item" 
							 ...
							 columnClasses="columnaTablaTexto,  columnaTablaNumero,columnaTablaTexto, columnaTablaNumero,columnaTablaCentrada,columnaTablaCentrada, columnaTablaCentradaFijo21"
