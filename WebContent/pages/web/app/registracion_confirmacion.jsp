					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td colspan="2" align="left" valign="top"><label
								for="pin"><span class="mediumFont"><h:outputText
										value="#{Message.tit_clave_ingreso_label}" /> </span> </label>
										 <t:inputText id="pin" 	value="#{registrationConfirmationBean.pin}" /></td>
						</tr>
						<tr>
							...
							<span class="mediumFont"><h:outputText 	value="#{Message.tit_email_label}" /> </span></label>
								<t:inputText id="email"
									value="#{registrationConfirmationBean.email}" /></td>
						</tr>
						<tr>
