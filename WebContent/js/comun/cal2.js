...
var daysColor="#EDECE9";
//var bodyColor="#ffffff";
var bodyColor="#BEC7BA";
var dayColor="#ffffff";
...
var leftWih = (screen.width) ? (screen.width-770)/2 : 0;
...
function showCal2(name) {  //Centra Calendario en Pantalla EAH 22/03/2005
  var lastCal=currentCal;
  var d=new Date(), hasCal=false;

  var winX=550, winY=350; //EAH 22/03/2005
