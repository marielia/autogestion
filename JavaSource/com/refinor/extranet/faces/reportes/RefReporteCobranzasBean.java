...
public class RefReporteCobranzasBean extends AbstListado{

	public RefReporteCobranzasBean() {
	...
	public void buscar(ActionEvent event)throws NoExistenItemsException, DataAccessErrorException ,Exception{
		try{			
			...
			setItems(mfacturasVDAO.getCobranzasPorClienteFecha(fltFechaDesde,fltFechaHasta,fltClienteDesde,fltClienteHasta));	
