...
public class RefReporteAsientosConDiferencias extends AbstListado {

	public RefReporteAsientosConDiferencias() {
	...
	public void generarExcel() {
		try{			
			...
			if(getItems()!=null && getItems().size()!=0){
				...
				this.nombreArchivo = exportarExcelBean.generarExcelReporteAsientoConDiferecias(getItems(),getFechaActualStr(),getTipoUsuarioLogueado());	
	...
	public void buscar(ActionEvent event)throws NoExistenItemsException, DataAccessErrorException ,Exception{
		try{			
			...
			setItems(mAsientoContableDAO.getAsientosConDiferenciasv2(this.fltNroAsientoDesde,this.fltNroAsientoHasta,ccss));	
