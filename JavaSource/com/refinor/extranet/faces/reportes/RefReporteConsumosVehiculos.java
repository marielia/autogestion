...
public class RefReporteConsumosVehiculos extends AbstListado {

	public RefReporteConsumosVehiculos() {
	...
	public void buscar(ActionEvent event)throws NoExistenItemsException, DataAccessErrorException ,Exception{
		try{			
			...
			if(getTipoUsuarioLogueado()==1){
				//es cliente
				setItems(mPedidoDAO.getConsumosPorVehiculo(codCliente,fltFechaDesde,fltFechaHasta, fltPatente,getUnidadNegocio(),fltDescripcionUnidadNegocio,getGrupoUnidadNegocio(),fltDescripcionGrupoUN,false));	
				...
				setItems(mPedidoDAO.getConsumosPorVehiculo(codClienteAlfa,fltFechaDesde,fltFechaHasta, fltPatente,getUnidadNegocio(),fltDescripcionUnidadNegocio,getGrupoUnidadNegocio(),fltDescripcionGrupoUN,false));	
	...
	public void generarExcel() {
		try{			
			...
			if(getItems()!=null && getItems().size()!=0){
				...
				this.nombreArchivo = exportarExcelBean.generarExcelReporteConsumos(getItems(),getFechaActualStr(),true,getTipoUsuarioLogueado());
			}
