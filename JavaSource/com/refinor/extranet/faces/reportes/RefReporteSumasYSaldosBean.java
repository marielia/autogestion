...
public class RefReporteSumasYSaldosBean extends AbstListado {

	public RefReporteSumasYSaldosBean() {
	...
	public void generarExcel() {
		try{			
			...
			if(getItems()!=null && getItems().size()!=0){
				...
				this.nombreArchivo = exportarExcelBean.generarExcelReporteSumasSaldos(getItems(),getFechaActualStr(),getTipoUsuarioLogueado());	
	...
	public void buscar(ActionEvent event)throws NoExistenItemsException, DataAccessErrorException ,Exception{
		try{			
			...
			setItems(mAsientoContableDAO.getSumasSaldos(fltFechaDesde,fltFechaHasta,ccss));	
