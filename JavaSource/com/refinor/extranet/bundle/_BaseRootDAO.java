package com.refinor.extranet.bundle;
...
public abstract class _BaseRootDAO {
	...
	public static void initialize () {
		com.refinor.extranet.data.dao._RootDAO.initialize(
			(String) null);
	}
	...
	public static void initialize (String configFileName) {
		com.refinor.extranet.data.dao._RootDAO.initialize(
			configFileName,
			com.refinor.extranet.data.dao._RootDAO.getNewConfiguration(
				null));
	}
	...
	public static void initialize (String configFileName, Configuration configuration) {
		if (null != sessionFactoryMap && null != sessionFactoryMap.get(configFileName)) return;
			...
			if (null == configFileName) {
				...
				com.refinor.extranet.data.dao._RootDAO.setSessionFactory(
					null,
	...
	public String getConfigurationFileName () {		
		FileUtil fileUtil= new FileUtil();
   		...
   		String pathConfHibernate= props.getProperty(Const.ARCHIVO_CONF_HIBERNATE);
   		System.out.println("BaseRootDAO ->" + pathConfHibernate);
		return pathConfHibernate;		
	}
