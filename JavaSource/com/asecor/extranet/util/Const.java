...
public class Const { 
	...
	public static String ANCLA_INDEX_TMP= "indexTemp";
	...
	public static String PARAM_AGENCY_ID="agencyId"; 
	...
	public static String PARAM_USER_DNI = "dni";
	
	//tabla parameter
	public static String URL_SELECTOR="URL_SELECTOR";
	public static String TPBTSERVICE_INSERTOGINREQUEST="TPBTSERVICE_INSERTOGINREQUEST";
	public static String URL_INDEX_PORTAL="URL_INDEX_PORTAL"; 
	public static String SISTEMA="asecorportal"; 
	public static String GO_TO_PORTAL="GO_TO_PORTAL"; 
	public static String CASINO="1";
...
//	public static Integer ROL_CLIENTE = new Integer(1);
	...
	public static String PARAM_TITULAR = "titular";
	public static String PARAM_RAMA="codRama";
	public static String PARAM_POLIZAS ="polizas";
	public static String PARAM_COD_SOLICITUD="codSolicitud";
	public static String PARAM_ESTADO_CUOTA = "estado";
